                    ...
                    <InputGroup className="mb-4">
                        <div className="registrationFormControl">
                            <label className="nonFloatingLabel">Expression</label>
                                ...
                                <TextareaEditor txtId="floatingExpression" callback={this.onChangeExpressionFromOutside} />
                                <div className="inputTip clearfix mt-3">For example, COUNT(id) &gt; 0, SUM(amount)  &lt; 100, etc.</div>
                        </div>
                    </InputGroup>
                    <Row>
                        <Col xs="6">
