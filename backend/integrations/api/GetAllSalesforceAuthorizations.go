...
func GetAllSalesforceAuthorizations(w http.ResponseWriter, r *http.Request) {
	...
	Collection, err := repositories.FindAllSalesforceAuthorizationsForOrganization(db, OrganizationUuid)
	...
	jsonResponse, _ := json.Marshal(
		map[string][]entities.SalesforceAuthorization{"items": Collection.Items},
	)
