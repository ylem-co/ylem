...
func GetAllJiraAuthorizations(w http.ResponseWriter, r *http.Request) {
	...
	Collection, err := repositories.FindAllJiraAuthorizationsForOrganization(db, OrganizationUuid)
	...
	jsonResponse, _ := json.Marshal(
		map[string][]entities.JiraAuthorization{"items": Collection.Items},
	)
