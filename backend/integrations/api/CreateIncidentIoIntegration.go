...
type HttpCreateIncidentIoIntegration struct {
	...
	Mode             string `json:"mode" valid:"type(string),required"`
	Visibility       string `json:"visibility" valid:"type(string),required"`
}

func CreateIncidentIoIntegration(w http.ResponseWriter, r *http.Request) {
	log.Tracef("Creating IncidentIo Integration")
	...
	var request HttpCreateIncidentIoIntegration
	...
	err = repositories.CreateIncidentIoIntegration(db, &entity)
	...
	log.Tracef("New incident.io Integration was created")
}
