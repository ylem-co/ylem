...
func GetAllSlackAuthorizations(w http.ResponseWriter, r *http.Request) {
	...
	Collection, err := repositories.FindAllSlackAuthorizationsForOrganization(db, OrganizationUuid)
	...
	jsonResponse, _ := json.Marshal(
		map[string][]entities.SlackAuthorization{"items": Collection.Items},
	)
