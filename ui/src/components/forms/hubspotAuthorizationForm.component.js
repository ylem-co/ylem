...
class HubspotAuthorizationForm extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        log.debug("HubspotAuthorizationForm component did mount")
                                    ...
                                    {justConnected && this.state.item.model.is_active && (
                                        <div className="form-group">
                                            <div className={ "alert alert-success mt-3" } role="alert">
                                                Congratulations! Your Hubspot is now connected. Feel free to rename the authorization, if you are up to.
                                            </div>
                                        </div>
                                    )}
                                    <Form
                                        ...
                                        {message && (
                                            <div className="form-group">
                                                <div className={ this.state.successful ? "alert alert-success mt-3" : "alert alert-danger mt-3" } role="alert">
                                                    {message.item ? "Hubspot authorization updated" : message}
                                                </div>
                                            </div>
                                        )}
                                        <CheckButton
...
export default connect(mapStateToProps)(HubspotAuthorizationForm);
